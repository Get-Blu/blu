...
const meta: Meta<typeof MockApp> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: `
The ChatView component is the main interface for interacting with Blu. It provides a comprehensive chat experience with AI assistance, task management, and various tools.
...
const createMessage = (
	minutesAgo: number,
	type: BluMessage["type"],
	say: BluMessage["say"],
	text: string,
	overrides: Partial<BluMessage> = {},
): BluMessage => ({
...
const mockActiveMessages: BluMessage[] = [
...
const mockStreamingMessages: BluMessage[] = [
	...mockActiveMessages,
	createMessage(
		0.17,
		"say",
...
const createMockState = (overrides: any = {}) => ({
	...
	showWelcome: false,
	bluMessages: mockActiveMessages,
...
export const WelcomeScreen: Story = {
	decorators: [createStoryDecorator({ welcomeViewCompleted: false, showWelcome: true, bluMessages: [] })],
	parameters: {
		docs: {
			description: {
...
export const ActiveConversation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "An active conversation showing a typical interaction with Blu, including task creation, tool usage, and AI responses.",
			},
		},
	},
}
...
export const StreamingResponse: Story = {
	decorators: [createStoryDecorator({ bluMessages: mockStreamingMessages })],
	parameters: {
		docs: {
			description: {
...
const createLongMessages = (): BluMessage[] => [
...
export const LongConversation: Story = {
	decorators: [createStoryDecorator({ bluMessages: createLongMessages() })],
	parameters: {
		docs: {
			description: {
...
export const ErrorState: Story = {
	decorators: [createStoryDecorator({ bluMessages: createErrorMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows how Blu handles and displays error messages, helping users understand and resolve issues.",
			},
		},
	},
}
...
export const AutoApprovalEnabled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows the interface with auto-approval enabled, allowing Blu to execute certain actions automatically without user confirmation.",
			},
		},
	},
}
...
export const PlanMode: Story = {
	decorators: [
		createStoryDecorator({
			bluMessages: createPlanModeMessages(),
	...
	parameters: {
		docs: {
			description: {
				story: "Shows Blu in Plan mode, where it focuses on creating detailed plans and discussing approaches before implementation.",
			},
		},
	},
}
...
export const EmptyState: Story = {
	decorators: [createStoryDecorator({ bluMessages: [], taskHistory: [], isNewUser: true })],
	parameters: {
		docs: {
			description: {
...
export const BrowserAutomation: Story = {
	decorators: [createStoryDecorator({ bluMessages: createBrowserMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows Blu performing browser automation tasks, including launching browsers, clicking elements, and testing web applications.",
			},
		},
	},
}
...
export const ToolApproval: Story = {
	decorators: [createStoryDecorator({ bluMessages: createToolApprovalMessages() })],
	parameters: {
		docs: {
			description: {
...
export const Followup = quickStory(
	...
	"Shows followup question state where Blu asks for next steps.",
)
...
export const PlanModeResponse = quickStory(
	...
	"Shows plan mode response where Blu presents a detailed plan for user approval.",
)
...
export const ReportBug = quickStory(
	"Report Bug",
	"report_bug",
	"Would you like to report this issue to help improve Blu?",
