...
import { SapAiCoreModelDeployment } from "@shared/proto/index.blu"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in Blu
		...
		// Models that are supported in Blu but NOT deployed
