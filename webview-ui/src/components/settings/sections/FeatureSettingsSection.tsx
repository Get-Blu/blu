						...
						<div
							...
							<p className="text-xs mt-1 mb-0">
								...
								<span className="text-description">
									Allows Blu to spawn subprocesses to handle focused tasks like exploring large codebases,
								...
								onChange={(e: any) => {
									...
									if (!Number.isNaN(value) && value >= 1 && value <= 100) {
										updateSetting("focusChainSettings", {
											...focusChainSettings,
											remindBluInterval: value,
										})
									}
								}}
								value={String(focusChainSettings?.remindBluInterval || 6)}
							/>
							<p className="text-xs mt-[5px] text-(--vscode-descriptionForeground)">
								Interval (in messages) to remind Blu about its focus chain checklist (1-100). Lower values
					...
					{dictationSettings?.featureEnabled && (
						<div className="mt-2.5">
							...
							<p className="text-xs text-description mt-1">
								Enables speech-to-text transcription using your Blu account. Uses the Aqua Voice's Avalon model,
					...
					<div style={{ marginTop: 10 }}>
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							...
							<a
								...
								href="https://docs.getblu.in/features/auto-compact"
					...
					{multiRootSetting.featureFlag && (
						<div className="mt-2.5">
							...
							<p className="text-xs">
								...
								<span className="text-description">Allows blu to work across multiple workspaces.</span>
							</p>
						</div>
					)}
						...
						<div className="mt-2.5">
							...
							{!isMacOSOrLinux() ? (
								...
								<p className="text-xs">
									<span className="text-(--vscode-errorForeground)">Experimental: </span>{" "}
									<span className="text-description">
										Allows execution of hooks from .blurules/hooks/ directory.
									</span>
								</p>
							)}
						</div>
