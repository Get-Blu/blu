	...
	if (usePlatform().type === PlatformType.VSCODE) {
		return (
			<a
				...
				href="https://docs.getblu.in/features/customization/opening-blu-in-sidebar"
				rel="noopener noreferrer"
				style={{ color: "var(--vscode-foreground)", outline: "none" }}
				target="_blank">
				<h4 className="m-0">💡 Blu in the Right Sidebar</h4>
				<p className="m-0">
					Keep your files visible when chatting with Blu. Drag the Blu icon to the right sidebar panel for a better
