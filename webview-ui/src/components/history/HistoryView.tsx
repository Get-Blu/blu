import { BooleanRequest, EmptyRequest, StringArrayRequest, StringRequest } from "@shared/proto/blu/common"
import { GetTaskHistoryRequest, TaskFavoriteRequest } from "@shared/proto/blu/task"
		...
		<>
			...
			<div className="fixed overflow-hidden inset-0 flex flex-col">
				...
				<div
					...
					<BluLogoWhite className="size-15" />
					<span
						style={{
							fontSize: "18px",
							fontWeight: 600,
