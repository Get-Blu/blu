...
import { BluError, BluErrorType } from "../../../../src/services/error/BluError"
...
export const ErrorBlockTitle = ({
	...
	const title = (() => {
		...
		if (apiReqCancelReason === "user_cancelled") {
			...
			const bluError = BluError.parse(apiRequestFailedMessage)
			const titleText = bluError?.isErrorType(BluErrorType.Balance) ? "Credit Limit Reached" : "API Request Failed"
