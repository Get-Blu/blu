...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					Blu is now available with unlimited seats. Includes JetBrains support, role-based access control, and
					centralized billing.{" "}
					<VSCodeLink
						href="https://app.getblu.in/login/?utm_source=ext&utm_medium=banner&utm_campaign=free-teams"
						style={linkStyle}>
						Get started with Teams
					</VSCodeLink>
				</li>
				<li>
					Native tool calling is now the default for Claude 3.5, Gemini 1.5, Grok 3/Code, and GPT-4. Reduces errors by
			...
			<p style={linkContainerStyle}>
				Join us on{" "}
				<VSCodeLink href="https://x.com/blu" style={linkStyle}>
					X,
				</VSCodeLink>{" "}
				<VSCodeLink href="https://discord.gg/blu" style={linkStyle}>
					discord,
				</VSCodeLink>{" "}
				or{" "}
				<VSCodeLink href="https://www.reddit.com/r/blu/" style={linkStyle}>
					r/blu
				</VSCodeLink>
				for more updates!
			</p>
