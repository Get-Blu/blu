import type { BluMessage, BluSayTool } from "@shared/ExtensionMessage"
 ...
 */
export function getButtonConfig(message: BluMessage | undefined, _mode: Mode = "act"): ButtonConfig {
	if (!message) {
