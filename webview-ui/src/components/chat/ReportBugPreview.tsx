...
const ReportBugPreview: React.FC<ReportBugPreviewProps> = ({ data }) => {
	...
	return (
		<div className="bg-(--vscode-badge-background) text-(--vscode-badge-foreground) rounded-lg p-[14px]">
			...
			<div className="space-y-3 text-sm">
				...
				{(bugData.blu_version || bugData.blu_version) && (
					<div>
						<div className="font-semibold">Blu Version</div>
						<MarkdownBlock markdown={bugData.blu_version || bugData.blu_version} />
					</div>
				)}
