...
// Blu Provider model schema with per-model settings
export const BluModelSchema = z.object({
	id: z.string(), // The model ID is required
})

// Blu Provider specific settings
export const BluSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(BluModelSchema).optional(),
})
...
const ProviderSettingsSchema = z.object({
	...
	Blu: BluSettingsSchema.optional(),
})
...
// Settings for a global blu rules or workflow file.
