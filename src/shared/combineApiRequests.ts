...
/**
 * Combines API request start and finish messages in an array of BluMessages.
 *
 ...
 * @returns A new array of BluMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: BluMessage[]): BluMessage[] {
	const combinedApiRequests: BluMessage[] = []
