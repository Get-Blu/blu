...
import { BluFeatureSetting } from "./BluFeatureSetting"
import { BluRulesToggles } from "./blu-rules"
import { DictationSettings } from "./DictationSettings"
import { FocusChainSettings } from "./FocusChainSettings"
import { HistoryItem } from "./HistoryItem"
import { PromptEngineeringSettings } from "./PromptEngineeringSettings"
...
export const COMMAND_CANCEL_TOKEN = "__blu_command_cancel__"
...
export interface ExtensionState {
	...
	version: string
	distinctId: string
	globalBluRulesToggles: BluRulesToggles
	localBluRulesToggles: BluRulesToggles
	localWorkflowToggles: BluRulesToggles
	globalWorkflowToggles: BluRulesToggles
	localCursorRulesToggles: BluRulesToggles
	localWindsurfRulesToggles: BluRulesToggles
	...
	promptEngineeringSettings: PromptEngineeringSettings
	customPrompt?: string
	...
	multiRootSetting: BluFeatureSetting
	...
	nativeToolCallSetting?: BluFeatureSetting
}

export interface BluMessage {
	ts: number
	type: "ask" | "say"
	ask?: BluAsk
	say?: BluSay
...
export interface BluSayBrowserAction {
...
export interface BluAskUseMcpServer {
	serverName: string
...
export interface BluPlanModeResponse {
	response: string
	options?: string[]
	selected?: string
}

export interface BluAskQuestion {
	question: string
	options?: string[]
	selected?: string
}

export interface BluAskNewTask {
	context: string
}

export interface BluApiReqInfo {
	request?: string
	tokensIn?: number
	tokensOut?: number
	cacheWrites?: number
	cacheReads?: number
	cost?: number
	cancelReason?: BluApiReqCancelReason
...
export type BluApiReqCancelReason = "streaming_failed" | "user_cancelled" | "retries_exhausted"
