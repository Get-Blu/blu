...
export const anthropicDefaultModelId: AnthropicModelId = "claude-opus-4-5-20251101"
...
export const bedrockDefaultModelId: BedrockModelId = "anthropic.claude-opus-4-5-20251101-v1:0"
...
export const openRouterDefaultModelId = "anthropic/claude-opus-4.5" // will always exist in openRouterModels
...
export const openRouterDefaultModelInfo: ModelInfo = {
	...
	cacheReadsPrice: 0.5,
	description:
		"Claude Opus 4.5 is Anthropic's most intelligent model, delivering state-of-the-art performance across reasoning, coding, and creative tasks. It is designed to handle the most complex challenges and provides a significant leap in capability over its predecessors.",
}
...
export const vertexDefaultModelId: VertexModelId = "claude-opus-4-5@20251101"
...
export const openAiNativeDefaultModelId: OpenAiNativeModelId = "gpt-5.2-thinking"
...
export const cerebrasModels = {
	...
	"qwen-3-coder-480b-free": {
		...
		outputPrice: 0,
		description:
			"SOTA coding model with ~2000 tokens/s ($0 free tier)\n\n• Use this if you don't have a Cerebras subscription\n• 64K context window\n• Rate limits: 150K TPM, 1M TPH/TPD, 10 RPM, 100 RPH/RPD\n\nUpgrade for higher limits: [https://cloud.cerebras.ai/?utm=blu](https://cloud.cerebras.ai/?utm=blu)",
	},
	"qwen-3-coder-480b": {
		maxTokens: 40000,
		contextWindow: 128000,
...
export const requestyDefaultModelId = "anthropic/claude-opus-4.5"
export const requestyDefaultModelInfo: ModelInfo = {
	...
	cacheWritesPrice: 6.25,
	cacheReadsPrice: 0.5,
	description: "Claude Opus 4.5 is Anthropic's most intelligent model.",
}

// SAP AI Core
export type SapAiCoreModelId = keyof typeof sapAiCoreModels
export const sapAiCoreDefaultModelId: SapAiCoreModelId = "anthropic--claude-4.5-opus"
