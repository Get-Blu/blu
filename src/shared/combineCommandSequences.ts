...
/**
 * Combines sequences of command and command_output messages in an array of BluMessages.
 *
 * This function processes an array of BluMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of BluMessage objects to process.
 * @returns A new array of BluMessage objects with command sequences combined.
 *
 * @example
 * const messages: BluMessage[] = [
 ...
 */
export function combineCommandSequences(messages: BluMessage[]): BluMessage[] {
	const combinedCommands: BluMessage[] = []
