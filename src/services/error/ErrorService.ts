...
export class ErrorService {
	...
	public logException(error: Error | BluError, properties?: Record<string, unknown>): void {
	...
	public toBluError(rawError: unknown, modelId?: string, providerId?: string): BluError {
		const transformed = BluError.transform(rawError, modelId, providerId)
