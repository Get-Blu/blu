...
import type { BluError } from "../BluError"
...
export interface IErrorProvider {
	 ...
	 * @param error The error to log (Error or BluError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | BluError, properties?: Record<string, unknown>): void
