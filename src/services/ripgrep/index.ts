...
export async function regexSearchFiles(
	...
	// Filter results using BluIgnoreController if provided
	const filteredResults = bluIgnoreController
		? results.filter((result) => bluIgnoreController.validateAccess(result.filePath))
		: results
