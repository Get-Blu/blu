...
import type { BluAccountUserInfo } from "../../../auth/AuthService"
...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	constructor() {
		...
		if (meterProvider) {
			this.meter = meterProvider.getMeter("blu")
		}

		if (loggerProvider) {
			this.logger = loggerProvider.getLogger("blu")
		}
	...
	public identifyUser(userInfo: BluAccountUserInfo, properties: TelemetryProperties = {}): void {
