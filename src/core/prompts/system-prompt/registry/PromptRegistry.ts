...
import { BluTool } from "@/shared/tools"
import { BluToolSet } from ".."
import { getSystemPromptComponents } from "../components"
import { registerBluToolSets } from "../tools"
...
export class PromptRegistry {
	...
	public nativeTools: BluTool[] | undefined = undefined
	...
	async get(context: SystemPromptContext): Promise<string> {
		...
		this.nativeTools = BluToolSet.getNativeTools(variant, context)
