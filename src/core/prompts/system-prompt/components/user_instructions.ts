...
export async function getUserInstructions(variant: PromptVariant, context: SystemPromptContext): Promise<string | undefined> {
	const customInstructions = buildUserInstructions(
		context.globalBluRulesFileInstructions,
		context.localBluRulesFileInstructions,
...
function buildUserInstructions(
	globalBluRulesFileInstructions?: string,
	localBluRulesFileInstructions?: string,
	localCursorRulesFileInstructions?: string,
	localCursorRulesDirInstructions?: string,
	localWindsurfRulesFileInstructions?: string,
	bluIgnoreInstructions?: string,
	...
	if (globalBluRulesFileInstructions) {
		customInstructions.push(globalBluRulesFileInstructions)
	}
	if (localBluRulesFileInstructions) {
		customInstructions.push(localBluRulesFileInstructions)
	}
	...
	if (bluIgnoreInstructions) {
		customInstructions.push(bluIgnoreInstructions)
	}
