...
export interface PromptVariant {
	...
	// Tool configuration
	readonly tools?: readonly BluDefaultTool[] // Ordered list of tools to include
	readonly toolOverrides?: Readonly<Partial<Record<BluDefaultTool, ConfigOverride>>> // Tool customizations
}
...
export interface MutablePromptVariant {
	...
	tools?: BluDefaultTool[]
	toolOverrides?: Partial<Record<BluDefaultTool, ConfigOverride>>
}
...
export interface PromptConfig {
	...
	readonly tools?: readonly BluToolSpec[]
...
export interface SystemPromptContext {
	...
	readonly globalBluRulesFileInstructions?: string
	readonly localBluRulesFileInstructions?: string
	...
	readonly bluIgnoreInstructions?: string
...
export type ToolKey = keyof typeof BluDefaultTool
export type ToolValue = (typeof BluDefaultTool)[ToolKey]
...
export function isValidBluDefaultTool(tool: string): tool is BluDefaultTool {
	return Object.values(BluDefaultTool).includes(tool as BluDefaultTool)
}
...
export interface VariantBuilder {
	...
	tools(...tools: BluDefaultTool[]): this
	overrideTool(tool: BluDefaultTool, override: ConfigOverride): this
