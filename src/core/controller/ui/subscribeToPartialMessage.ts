...
import { BluMessage } from "@shared/proto/blu/ui"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<BluMessage>>()
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<BluMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The BluMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: BluMessage): Promise<void> {
