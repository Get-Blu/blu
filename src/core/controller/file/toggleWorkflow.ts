import { BluRulesToggles, ToggleWorkflowRequest } from "@shared/proto/blu/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<BluRulesToggles> {
