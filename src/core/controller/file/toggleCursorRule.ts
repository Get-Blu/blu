import type { ToggleCursorRuleRequest } from "@shared/proto/blu/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<BluRulesToggles> {
