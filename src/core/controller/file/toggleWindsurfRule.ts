import type { ToggleWindsurfRuleRequest } from "@shared/proto/blu/file"
import { BluRulesToggles } from "@shared/proto/blu/file"
 ...
 */
export async function toggleWindsurfRule(controller: Controller, request: ToggleWindsurfRuleRequest): Promise<BluRulesToggles> {
	...
	return BluRulesToggles.create({ toggles: toggles })
}
