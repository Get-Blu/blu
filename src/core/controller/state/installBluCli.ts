import { Empty, EmptyRequest } from "@shared/proto/blu/common"
...
/**
 * Handles the installation of the Blu CLI tool
 * @param controller The controller instance
 * @param _request The empty request
 * @returns Empty response
 */
export async function installBluCli(_controller: Controller, _request: EmptyRequest): Promise<Empty> {
	const installCommand = "npm install -g blu"
