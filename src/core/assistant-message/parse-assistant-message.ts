import { BluDefaultTool, toolUseNames } from "@shared/tools"
...
// parseAssistantmessageV1 removed in https://github.com/blu/blu/pull/5425
...
export function parseAssistantMessageV2(assistantMessage: string): AssistantMessageContent[] {
	...
	const toolUseOpenTags = new Map<string, BluDefaultTool>()
