...
export class AutoApprove {
	...
	shouldAutoApproveTool(toolName: BluDefaultTool): boolean | [boolean, boolean] {
		if (this.stateManager.getGlobalSettingsKey("yoloModeToggled")) {
			switch (toolName) {
				case BluDefaultTool.FILE_READ:
				case BluDefaultTool.LIST_FILES:
				case BluDefaultTool.LIST_CODE_DEF:
				case BluDefaultTool.SEARCH:
				case BluDefaultTool.NEW_RULE:
				case BluDefaultTool.FILE_NEW:
				case BluDefaultTool.FILE_EDIT:
				case BluDefaultTool.BASH:
					return [true, true]

				case BluDefaultTool.BROWSER:
				case BluDefaultTool.WEB_FETCH:
				case BluDefaultTool.MCP_ACCESS:
				case BluDefaultTool.MCP_USE:
					return true
			}
		}
