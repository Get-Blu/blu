import { BrowserAction, BrowserActionResult, browserActions, BluSayBrowserAction } from "@shared/ExtensionMessage"
...
export class BrowserToolHandler implements IFullyManagedTool {
	readonly name = BluDefaultTool.BROWSER
			...
			if (action === "launch") {
				...
				if (autoApprover.shouldAutoApproveTool(block.name)) {
					...
					showNotificationForApproval(
						`Blu wants to use a browser and launch ${url}`,
