...
export async function refreshWorkflowToggles(
	...
	const globalBluWorkflowsFilePath = await ensureWorkflowsDirectoryExists()
	const updatedGlobalWorkflowToggles = await synchronizeRuleToggles(globalBluWorkflowsFilePath, globalWorkflowToggles)
