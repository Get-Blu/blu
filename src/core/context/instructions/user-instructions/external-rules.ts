...
export async function refreshExternalRulesToggles(
	...
	windsurfLocalToggles: BluRulesToggles
	cursorLocalToggles: BluRulesToggles
}> {
 ...
 */
export const getLocalWindsurfRules = async (cwd: string, toggles: BluRulesToggles) => {
 ...
 */
export const getLocalCursorRules = async (cwd: string, toggles: BluRulesToggles) => {
