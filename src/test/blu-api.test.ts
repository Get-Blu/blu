...
import type { BluAPI } from "../exports/blu"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("BluAPI Core Functionality", () => {
	let api: BluAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createBluAPI expects
		...
		// Create API instance
		api = createBluAPI(mockController)
	})
