 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Blu's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Blu Checkpoint")
		await git.addConfig("user.email", "checkpoint@getblu.in")
