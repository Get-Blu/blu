...
if (process.env.BLU_ENVIRONMENT) {
	buildEnvVars["process.env.BLU_ENVIRONMENT"] = JSON.stringify(process.env.BLU_ENVIRONMENT)
}
...
const standaloneConfig = {
	...baseConfig,
	entryPoints: ["src/standalone/blu-core.ts"],
	outfile: `${destDir}/blu-core.js`,
